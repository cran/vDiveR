...
plot3<-function(data,dot_size=2,word_size=15,alpha=1/3){
    ...
    plot3b_variants<-ggplot(variants)+geom_violin(mapping=aes(x=x,y=Incidence,color=Group,fill=Group))+
        ...
        theme_classic(base_size = word_size-2)+
        labs(y=NULL,x=NULL)+
        ...
        theme(strip.placement = "outside",
              ...
              axis.text.y = element_text(size=word_size/2-1),
